...
class TensorboardManager:
    def __init__(self, base_path, run_name=None):
        """
        初始化 TensorboardManager，确保每次运行生成单独的日志目录。

        :param base_path: 基础日志目录
        :param run_name: 可选的运行名称，若未指定则使用时间戳生成
        """
        # 确保基础目录存在
        ...
        # 构造运行日志目录
        self.log_dir = os.path.join(base_path, run_name)
